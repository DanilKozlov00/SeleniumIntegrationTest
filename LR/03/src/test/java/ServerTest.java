...
// for {8, 2, 10}, numberA = 8, numberB = 2, expected = 10
    ...
    public ServerTest(String Gison,String expectedMesType,String expectedNomerLabi, String expectedNomer,String expectedSilka) throws ParseException, IOException {
